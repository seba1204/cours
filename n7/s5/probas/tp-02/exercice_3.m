...
for i = 1:length(texte)
	...
	texte_encode_courant = (texte_encode_courant-bornes(c, 1))/selection_frequences(c);	% Soustraction de la borne inferieure et division par la probabilite pour obtenir le caractere suivant
end
